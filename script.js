...
var wallpaperRegistry = {
    "Default": {id: "Default", name: "Snake Skeleton", url: "video-default.mp4", locked: false},
    ...
    "Gojo-Sukuna": {id: "Gojo-Sukuna", name: "Gojo vs Sukuna", url: "video-gojo-sukuna.mp4", locked: false},
    "Hunt": {id: "Hunt", name: "Hunt Showdown 2", url: "video-hunt.mp4", locked: false},
    "Minecraft01": {id: "Minecraft01", name: "Minecraft 01", url: "video-minecraft01.mp4", locked: false},
    "Minecraft02": {id: "Minecraft02", name: "Minecraft 02", url: "video-minecraft02.mp4", locked: false},
    "Minecraft03": {id: "Minecraft03", name: "Minecraft 03", url: "video-minecraft03.mp4", locked: false},
    "Monkey": {id: "Monkey", name: "Monkey", url: "video-monkey.mp4", locked: false},
    "Skello": {id: "Skello", name: "Skello", url: "video-skello.mp4", locked: false},
    "SnowFox": {id: "SnowFox", name: "Snow Fox", url: "video-snowfox.mp4", locked: false},
    "Supra": {id: "Supra", name: "Supra Drift", url: "video-supra.png", locked: false},
    "Yuji52": {id: "Yuji52", name: "Yuji 52", url: "video-yuji52.mp4", locked: false},
    "sukuna-fire": {id: "sukuna-fire", name: "Sukuna Fire", url: "video-sukuna-fire.mp4", locked: false},
    "CozyFox": {id: "CozyFox", name: "Cozy Fox", url: "video-cozyfox.mp4", locked: false},
    "RainyCity": {id: "RainyCity", name: "Rainy City", url: "video-rainycity.mp4", locked: false},
    "Gojo": {id: "Gojo", name: "Gojo", url: "video-gojo.mp4", locked: false},
    "BlackHole": {id: "BlackHole", name: "Black Hole", url: "video-blackhole.mp4", locked: false},
    "Yuta": {id: "Yuta", name: "Yuta", url: "video-yuta.mp4", locked: false},
...
function renderUI() {
    ...
    let dHTML = '<div class="dock-item" onclick="toggleStartMenu()"><img src="arch-mark.svg" alt="Anchor OS"></div><div class="dock-sep"></div><div class="dock-item" onclick="toggleAppDrawer()"><svg width="24" height="24" viewBox="0 0 24 24" fill="#aaa"><path d="M4 4h4v4H4zm6 0h4v4h-4zm6 0h4v4h-4zM4 10h4v4H4zm6 0h4v4h-4zm6 0h4v4h-4zM4 16h4v4H4zm6 0h4v4h-4zm6 0h4v4h-4z"/></svg></div><div class="dock-sep"></div>';
...
window.unlockSystem = function() {
    ...
    setTimeout(function() {
        ...
        if(!welcomeShown) {
            showNotification("Welcome To Anchor OS", "Welcome to the AnchoredVerses.");
            welcomeShown = true;
        }
    }, 600);
    resetIdle();
...
function initWallpapers() {
    ...
    if(wallpaperRegistry[sysConfig.lockWallpaper]) {
        ...
        applyMediaToElements("video-green.mp4", lV, lI, false);
    }
                ...
                <body>
                    ...
                    <div class="setting-card">
                        ...
                        <select id="cloak-select" onchange="window.parent.updateCloak(this.value)">
                            <option value="none">None (Anchor OS)</option>
